...
static void glad_gl_load_GL_VERSION_1_0(GLADuserptrloadfunc load,
    ...
    glad_glGetClipPlane =
        (PFNGLGETCLIPPLANEPROC)load(userptr, "glGetClipPlane");
    ...
    glad_glLightModeliv =
        (PFNGLLIGHTMODELIVPROC)load(userptr, "glLightModeliv");
    ...
    glad_glSelectBuffer =
        (PFNGLSELECTBUFFERPROC)load(userptr, "glSelectBuffer");
...
static void glad_gl_load_GL_VERSION_1_1(GLADuserptrloadfunc load,
    ...
    glad_glArrayElement =
        (PFNGLARRAYELEMENTPROC)load(userptr, "glArrayElement");
    ...
    glad_glIndexPointer =
        (PFNGLINDEXPOINTERPROC)load(userptr, "glIndexPointer");
...
static void glad_gl_load_GL_VERSION_4_5(GLADuserptrloadfunc load,
    ...
    glad_glGetnConvolutionFilter = (PFNGLGETNCONVOLUTIONFILTERPROC)load(
        userptr, "glGetnConvolutionFilter");
